...
export class FieldExperiencesService {
  ...
  create(createFieldExperienceInput: CreateFieldExperienceInput): Promise<FieldExperience> {
    const newFieldExperience = this.fieldExperienceRepository.create(createFieldExperienceInput);
  ...
  findByPersonInformationId(personInformationId: number): Promise<FieldExperience[]> {
    return this.fieldExperienceRepository.find({
      where: {
  ...
  update(id: number, updateFieldExperienceInput: UpdateFieldExperienceInput): Promise<FieldExperience> {
