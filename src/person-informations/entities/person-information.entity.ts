...
export class PersonInformation {
  ...
  @Column()
  @Field((type) => Int, {
    description: "The ID of the person this information belongs to",
  })
  personId: number;

  // Relations
  @OneToOne((type) => Person, (person) => person.personInformation, {
    // cascade: true,
  })
  @JoinColumn()
  @Field((type) => Person, {
    description: "The person this person information belongs to",
  })
  person: Person;

  @OneToMany(() => SocialMedia, (socialMedia) => socialMedia.person, {
    cascade: true,
  })
  ...
  @OneToMany(
    () => FieldExperience,
    (fieldExperience) => fieldExperience.person,
    { cascade: true }
  )
  @Field((type) => [FieldExperience], {
    nullable: true,
