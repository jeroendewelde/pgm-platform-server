...
export class Course {
  ...
  @Field((type) => [Project], {
    description: "The List of projects made for this course",
    nullable: true,
  })
  projects?: Project[];
  ...
  @ManyToMany(() => Attachment, (attachment) => attachment.courses, {
    nullable: true,
    cascade: true,
  })
  ...
  @ManyToOne(() => LearningLine, (LearningLine) => LearningLine.courses, {
    onDelete: "CASCADE",
  })
  @Field(() => LearningLine, {
    description: "The learning line this course belongs to",
  })
  learningLine: LearningLine;

  @ManyToOne(() => Specialisation, (specialisation) => specialisation.courses, {
    onDelete: "CASCADE",
    nullable: true,
  })
  @Field(() => Specialisation, {
    description: "The specialisation this course belongs to",
    nullable: true,
  })
