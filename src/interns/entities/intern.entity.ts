...
export class Intern {
  ...
  @JoinColumn()
  @Field(() => Person, { description: 'The student this intern belongs to' })
  student: Person

  @ManyToOne(() => Company, company => company.interns, { nullable: true, onDelete: 'CASCADE' })
  @Field(() => Company, { description: 'The company this intern worked at', nullable: true })
  company?: Company[]
}
